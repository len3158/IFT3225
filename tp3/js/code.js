...
$(function(){
    ...
    //Empecher les touches fleches de faire bouger la fenetre lorsqu'elle sont actives
    ...
    var game={
        ...
        Dom:function(){
            ...
            this.$deplacements_server = $(".mouveCount_server");
            this.$window=$(window);
        },
       ...
       swap:function(to,from) {
        ...
        updateCounter:function(){
            ...
            this.$deplacements_server.html(parseInt(this.$deplacements_server.text())+1);
                      
        },
        resetCounter:function(){
            this.$deplacements.html(0);  
            this.$deplacements_server.html(0);
